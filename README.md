...
<details>
  ...
  * Data para entrega final do projeto: `14/03/2024 23:59`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-038-project-trybewallet.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-038-project-trybewallet`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-038-project-trybewallet`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-038-project-trybewallet/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-038-project-trybewallet/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH38&template=betrybe/sd-0x-project-trybewallet-ts)
...
* <details><summary> Crie um botão com o texto <code>Entrar</code>:</summary>
  ...
  - Salve o e-mail no estado global da aplicação com a chave `email` assim que a pessoa usuária logar.
...
- O e-mail é salvo no estado da aplicação, com a chave `email`, assim que a pessoa usuária loga na página.
